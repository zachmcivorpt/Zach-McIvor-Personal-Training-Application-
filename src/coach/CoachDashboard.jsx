      ...
      <div className="grid grid-cols-3 gap-4">
        <Card className="col-span-1 h-fit">
          ...
          <div className="space-y-2">
            <button onClick={() => onNavigate("clients")} className="w-full flex items-center gap-3 bg-white/5 hover:bg-white/8 rounded-xl px-4 py-3 transition-colors">
            ...
            <button onClick={() => onNavigate("programs")} className="w-full flex items-center gap-3 bg-white/5 hover:bg-white/8 rounded-xl px-4 py-3 transition-colors">
            ...
            <button onClick={() => onNavigate("exercises")} className="w-full flex items-center gap-3 bg-white/5 hover:bg-white/8 rounded-xl px-4 py-3 transition-colors">
