...
// ---- Breakfasts ----
meals.push(
  meal("Protein Oats with Banana", [["g07", 60], ["p01", 30], ["d04", 200], ["r01", 100]]),
  meal("Protein Oats with Mixed Berries", [["g07", 60], ["p01", 30], ["d19", 200], ["r50", 80]]),
  meal("Overnight Oats with Chia & Peanut Butter", [["g07", 50], ["n08", 15], ["n05", 20], ["d04", 180], ["d06", 100]]),
  meal("Scrambled Eggs on Wholemeal Toast", [["d01", 150], ["g09", 60], ["v28", 50]]),
  meal("Egg White Omelette with Spinach", [["d02", 200], ["d01", 55], ["v02", 40], ["n12", 5]]),
  meal("Greek Yoghurt Bowl with Berries & Almonds", [["d06", 200], ["r50", 80], ["n01", 15]]),
  meal("Cottage Cheese with Banana & Oats", [["d08", 150], ["r01", 100], ["g07", 30]]),
  meal("Protein Pancakes", [["g07", 50], ["d01", 100], ["p01", 30], ["r01", 80], ["d04", 60]]),
  meal("Egg Wholemeal Wrap", [["d01", 110], ["g09", 60]]),
  meal("Smoked Salmon & Avocado on Toast", [["f01", 80], ["v28", 60], ["g09", 60]]),
  meal("Chia Pudding with Almond Milk & Berries", [["n08", 30], ["d19", 200], ["r50", 60]]),
  meal("Turkey Mince & Egg Breakfast Hash", [["m32", 100], ["v06", 150], ["d01", 55]]),
  meal("Muesli with Greek Yoghurt", [["g07", 50], ["d06", 150], ["n01", 10], ["r01", 60]]),
  meal("Peanut Butter Banana Protein Shake", [["p01", 30], ["n05", 20], ["r01", 100], ["d04", 250]])
);

// ---- Snacks / shakes ----
meals.push(
  meal("Post-Workout Whey Protein Shake", [["p01", 35], ["d04", 300]]),
  meal("Whey Protein & Banana Shake", [["p01", 30], ["r01", 100], ["d19", 250]]),
  meal("Tuna & Rice Cakes", [["f02", 95], ["g13", 27]]),
  meal("Cottage Cheese & Rice Cakes", [["d08", 150], ["g13", 18]]),
  meal("Greek Yoghurt & Almonds", [["d06", 170], ["n01", 20]]),
  meal("Almonds & Banana", [["n01", 25], ["r01", 120]]),
  meal("Boiled Eggs & Avocado", [["d01", 110], ["v28", 60]]),
  meal("Peanut Butter Rice Cakes", [["g13", 18], ["n05", 25]]),
  meal("Chickpea & Spinach Salad", [["l03", 150], ["v02", 40], ["n12", 8]]),
  meal("Lentil & Mixed Salad Bowl", [["l04", 150], ["v61", 80], ["n12", 8]]),
  meal("Cottage Cheese & Berries", [["d08", 150], ["r50", 80]]),
  meal("Protein Shake with Oats", [["p01", 30], ["g07", 30], ["d04", 250]])
);
